...
const makeGetSettings = ({
  ...
  () => {
    return Bluebird.resolve()
      ...
      .then(([validatedConfig, accountId]) => {
        const mergedVariables = Object.assign({}, variables, { accountId });
        return deepMap(validatedConfig, value => interpolate({ value, variables: mergedVariables }))
      })
